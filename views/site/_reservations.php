                            ...
                            <?php foreach ($corr as $item): ?>
                                <?php
                                    ...
                                    foreach ($segments as $segment) {
                                        ...
                                        $fullName = trim(($v->conducteurObj->prenom ?? '') . ' ' . ($v->conducteurObj->nom ?? ''));
                                        if ($fullName !== '') {
                                            $conducteurs[] = $fullName;
                                        }
                                    ...
                                    <div class="card search-card h-100 d-flex flex-column card-correspondance"
                                        ...
                                        <?php if ($isValid && $startTrajet && $endTrajet): ?>
                                            <div class="card-body">
                                                ...
                                                <div class="bb-cities bb-cities-compact">
                                                ...
                                                <div class="result-meta">
                                                    ...
                                                    <?php if (!empty($conducteurLabel)): ?>
                                                        <div class="meta-row">
                                                            <span class="meta-label">Conducteur</span>
                                                            <span class="meta-value"><?= Html::encode($conducteurLabel) ?></span>
                                                        </div>
                                                    <?php endif; ?>
                                                </div>
